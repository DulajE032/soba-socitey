    ...
    <section id="about" className="about-container fade-in-up">
      <div className="about-content">
        ...
        <p className="maname-regular" style={{fontSize:'20px'}}>
          <a href="https://www.pdn.ac.lk" target="_blank" rel="noopener noreferrer" style={{color: 'inherit', textDecoration: 'underline'}}>පේරාදෙණිය විශ්ව විද්‍යාලයේ</a> සොබා සංගමය තිරසාර හා පරිසර හිතකාමී අනාගතයක් නිර්මාණය කිරීමෙහිලා කැපවෙන ශක්තිමත් සහයෝගී සමූහයක් ලෙස ක්‍රියාත්මක වෙමින් පවතී.
